...
$kategori = ($result_kategori->num_rows > 0) ? htmlspecialchars($result_kategori->fetch_assoc()["kategori_adi"]) : "";
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb__links">
                        ...
                        <a href="../kategoriler/<?php echo strtolower(str_replace(" ", "_", $kategori)); ?>.php"><?php echo $kategori; ?></a>
                            ...
                            <div class="anime__details__widget">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <ul>
                                            <li><span>Kategori:</span> <?php echo $kategori; ?></li>
